...
(function() {
  ...
  TagExe = (function() {
    ...
    TagExe.prototype.varGet3 = function(view_nm, tbl_nm, key, format_spec, custom_spec) {
      ...
      if ((_base = this.info_varGet3)[view_nm] == null) {
    ...
    TagExe.prototype.loadFistDef = function(flist_nm) {
      var _base;
      return (_base = this.fist_objects)[flist_nm] != null ? _base[flist_nm] : _base[flist_nm] = this.Epic.getFistInstance(flist_nm);
    };
    ...
    TagExe.prototype.Tag_form_part = function(oPt) {
      var any_req, choices, fl, fl_nm, fm_nm, help, hpfl, is_first, issues, ix, map, oFi, one_field_nm, orig, out, part, row, rows, s, show_req, value_fl_nm, _i, _j, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      ...
      for (_i = 0, _len = hpfl.length; _i < _len; _i++) {
        ...
        fl.value = (_ref4 = oFi.getHtmlFieldValue(value_fl_nm)) != null ? _ref4 : fl["default"];
    ...
    TagExe.prototype.Tag_form_action = function(oPt) {
      var action, attr, click_index, link, o, out_attrs, val, value, _base, _base1, _ref;
      link = {};
      if (oPt.attrs.src != null) {
        if ((_base = oPt.attrs).type == null) {
          _base.type = 'image';
        }
        if ((_base1 = oPt.attrs).border == null) {
          _base1.border = '0';
        }
      }
      out_attrs = [];
