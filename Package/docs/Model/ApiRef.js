...
(function() {
  ...
  ApiRef = (function(superClass) {
    extend(ApiRef, superClass);
    ...
    Fist: {
        ...
        Argument: [
          {
            param: 'fist_nm',
            type: 'string',
            details: 'Name of the fist which appears in your fist.coffee file'
          }
        ],
        Return: [
          {
        ...
        Argument: [
          {
            param: 'ctx',
            type: 'object',
            details: 'Is mutated to include 3 hashes: (the fist_nm): DB values, fist$success:, fist$errors:'
          }, {
            param: 'fist_nm',
            type: 'string',
            details: 'Name of the fist which appears in your fist.coffee file, placed into E.fist$(pkg_nm)'
          }
        ],
        Return: [
          {
      ...
      AFistDefinition: {
        ...
        Return: [
          {
            type: 'object',
            details: 'Hashed by the HTML field names definied in fist.coffee, e.g. FIELDS: part: via:'
          }
        ]
      },
      AFieldDefinition: {
        ...
        Argument: [
          {
            param: 'field_nm',
            type: 'string',
            details: 'Name of the field which appears in your fist.coffee file, placed into E.fist$(pkg_nm)'
          }
        ],
        Return: [
          {
            type: 'object',
            details: 'Hash of the HTML field\'s attributes definied in fist.coffee FIELDS: [] array.'
          }
        ]
      },
      AppClear: {
        ...
        Argument: [
          {
            param: 'token',
            type: 'string',
            details: 'Any string value used later to map to user friendly text using e.g. issues.coffee file, placed into E.issues$(pkg_nm)'
          }, {
            param: 'extra_info',
            type: 'Array of strings',
            details: 'Used when expanding to user friendly text using %1%, %2% etc.'
          }
        ],
        Return: [
          {
        ...
        Argument: [
          {
            ...
            param: 'more_options.loadDirs',
            type: '{pkg_nm: \'./path\'',
            details: 'For Dev, to load files dynamically from a package'
          }, {
            param: 'more_options.loader',
            type: 'class',
            details: 'When you wish to override the dynamic loader class, looks in E.Extra[]'
          }, {
            param: 'more_options.render',
            type: 'class',
            details: 'When you wish to override the rendering class, looks in E.Extra[]'
          }, {
            param: 'more_options.event',
            type: 'function',
            details: 'When you wish to override the event handling function'
          }, {
            param: 'more_options.dataAction',
            type: 'function',
            details: 'When you wish to override the handling of browser events'
          }, {
            param: 'init_func',
            type: 'function',
            details: 'Called after the EpicMvc structures are ready to run'
          }
        ],
        Return: [
          {
        ...
        Argument: [
          {
            param: 'action_lable',
            type: 'String',
            details: 'An action-lable to send to the Controller'
          }, {
            param: 'action_data',
            type: 'Hash',
            details: 'The data to send with this action, to the Controller'
          }
        ],
        Return: [
          {
      ...
      ENextCounter: {
        ...
        Return: [
          {
            type: 'integer',
            details: 'Unique value that increments from zero from the time EpicMvc was first loaded.'
          }
        ]
      },
      EModelFactory: {
        ...
        Return: [
          {
            type: 'object',
            details: 'The model instance.',
            type: 'object',
            details: 'A Table (array of hashs, one per row.)',
            type: 'varies',
            details: 'Typically void, by could be a promise.'
          }
        ]
      },
      _log2: {
        ...
        Argument: [
          {
            param: 'ix',
            type: 'String',
            details: 'User defined string as a unique index to set and then remove this message'
          }, {
            param: 'msg',
            type: 'String',
            details: 'User defined message to show in the onbeforeunload popup.'
          }
        ],
        Return: [
          {
        ...
        Argument: [
          {
            param: 'tables',
            type: 'Boolean',
            details: 'When passed as the boolean true, will invalidate all tables that currently exist in @Tables'
          }, {
            param: 'tables',
            type: 'Array of String',
            details: 'List of tables to invalidate.'
          }
        ],
        Return: [
          {
