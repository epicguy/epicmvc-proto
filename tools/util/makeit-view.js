...
(function() {
  ...
  doIt = function(pkg_nm) {
    return jsdom.env({
      html: "<html><body><div id='fill_me'></div></body></html>",
      scripts: ['..' + '/testlib/MockEpicSetup.js', '..' + '/testlib/json2.js', '..' + '/EpicMvc/parse.js', '..' + '/EpicMvc/util.js']
    }, function(err, window) {
      var MockLoadStrategy, f, load, out, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
      MockLoadStrategy = (function() {

        function MockLoadStrategy(pkg_nm) {
          this.pkg_nm = pkg_nm;
          this.path = '../DevHtml' + '/Package/' + this.pkg_nm + '/view/';
        }
