...
(function() {
  ...
  RenderStrategy$Base = (function() {
    ...
    RenderStrategy$Base.prototype.handleEvent = function(event_obj) {
      var attrs, data_action, data_params, f, files, i, ix, j, len, nm, old_params, prevent, rec, ref, ref1, ref2, target, type, val;
      ...
      ref1 = ['touches', 'changedTouches', 'targetTouches'];
...
/*Dev/manifest.coffee*/// Generated by CoffeeScript 1.9.2
(function() {
  E.manifest$Dev = {
    Model: ['Devl', 'View'],
    Extra: ['ParseFile'],
