...
(function() {
  ...
  AppConf = (function() {
    function AppConf(Epic, loadStrategy) {
      ...
      if ((_base = this.config).CLICKS == null) {
        _base.CLICKS = {};
      }
      if ((_base1 = this.config).MACROS == null) {
        _base1.MACROS = {};
      }
      if ((_base2 = this.config.OPTIONS).frame == null) {
        _base2.frame = {};
      }
    ...
    AppConf.prototype.loadFormsIf = function() {
      var form_nm, group, node, view_nm, _base, _i, _len, _ref, _ref1;
      if (this.config.FORMS === false) {
        ...
        for (view_nm in _ref) {
          ...
          if ((_base = this.config.FORMS)[group] == null) {
            _base[group] = {};
          }
          _ref1 = node.forms.split(',');
