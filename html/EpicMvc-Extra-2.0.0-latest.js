...
"fist_default":{preloaded:1,can_componentize:false,defer:0,content:function(){return oE.kids([['if',{val:oE.v2('Control','type','lc'),eq:'hidden'},function(){return [{tag:'input',attrs:{type:oE.v2('Control','type','lc'),name:oE.v2('Control','name'),value:oE.v2('Control','value')},children:[]}]}],['if',{val:oE.v2('Control','type','lc'),ne:'hidden'},function(){return [{tag:'div',attrs:{className:'form-group '+oE.v2('Control','issue','?has-error')},children:oE.kids([['if',{val:oE.v2('Control','type','lc'),ne:'yesno'},function(){return [{tag:'label',attrs:{htmlFor:oE.v2('Control','name'),className:'control-label'},children:oE.kids([['if_true',{name:'req'},function(){return [{tag:'span',attrs:{className:'form-req'},children:['*']}]}],' '+oE.v2('Control','label')+' '])}]}],{tag:'div',attrs:{className:'controls'},children:oE.kids([['if',{val:oE.v2('Control','type'),eq:'textarea'},function(){return [{tag:'textarea',attrs:oE.weed({name:oE.v2('Control','name'),'?required':oE.v2('Control','req'),'data-e-action':'event:Fist:'+oE.v2('Control','fistNm')+':'+oE.v2('Control','fieldNm')+':keyup-focus-blur'}),children:[' '+oE.v2('Control','value')+' ']}]}],['if',{val:oE.v2('Control','type','lc'),eq:'text'},function(){return [{tag:'input',attrs:oE.weed({type:oE.v2('Control','type','lc'),name:oE.v2('Control','name'),value:oE.v2('Control','value'),'?size':oE.v2('Control','width'),'?required':oE.v2('Control','req'),className:'form-control','data-e-action':'event:Fist:'+oE.v2('Control','fistNm')+':'+oE.v2('Control','fieldNm')+':keyup-focus-blur'}),children:[]}]}],['if',{val:oE.v2('Control','type','lc'),eq:'password'},function(){return [{tag:'input',attrs:oE.weed({type:oE.v2('Control','type','lc'),name:oE.v2('Control','name'),value:oE.v2('Control','value'),'?size':oE.v2('Control','width'),'?required':oE.v2('Control','req'),className:'form-control','data-e-action':'event:Fist:'+oE.v2('Control','fistNm')+':'+oE.v2('Control','fieldNm')+':keyup-focus-blur'}),children:[]}]}],['if',{val:oE.v2('Control','type','lc'),eq:'yesno'},function(){return [{tag:'label',attrs:{htmlFor:oE.v2('Control','id'),className:'control-label'},children:oE.kids([{tag:'input',attrs:oE.weed({type:'checkbox',name:oE.v2('Control','name'),id:oE.v2('Control','id'),value:oE.v2('Control','yes_val'),'?checked':oE.v2('Control','selected')}),children:[]},['if_true',{name:'req'},function(){return [{tag:'span',attrs:{className:'form-req'},children:['*']}]}],' '+oE.v2('Control','label')+' '])}]}],['if',{val:oE.v2('Control','type'),eq:'radio'},function(){return oE.kids([['foreach',{table:'Control/Choice'},function(){return [{tag:'label',attrs:{htmlFor:oE.v2('Control','id')+'-'+oE.v2('Choice','option'),className:'control-sublabel'},children:[{tag:'input',attrs:oE.weed({type:'radio',name:oE.v2('Control','name'),id:oE.v2('Control','id')+'-'+oE.v2('Choice','option'),value:oE.v2('Choice','value','esc'),'?checked':oE.v2('Choice','selected')}),children:[]},' '+oE.v2('Choice','option')+' ']}]}]])}],['if',{val:oE.v2('Control','type'),eq:'pulldown'},function(){return [{tag:'select',attrs:oE.weed({name:oE.v2('Control','name'),'?size':oE.v2('Control','size')}),children:oE.kids([['foreach',{table:'Control/Choice'},function(){return [{tag:'option',attrs:oE.weed({value:oE.v2('Choice','value','esc'),'?selected':oE.v2('Choice','selected')}),children:[' '+oE.v2('Choice','option')+' ']}]}]])}]}],['if',{set:oE.v2('Control','issue')},function(){return [{tag:'span',attrs:{className:'help-block field-error'},children:[oE.v2('Control','issue')]}]}]])}])}]}]])}}}};
