...
(function() {
  ...
  TagExe = (function() {
      ...
      switch (spec) {
        ...
        default:
          if (spec != null ? spec.length : void 0) {
            if ((typeof val === 'number' && val) || (val != null ? val.length : void 0)) {
    ...
    TagExe.prototype.Tag_foreach = function(oPt) {
      var at_table, break_rows_list, count, lh, limit, oMd, out, rh, row, tbl, _i, _len, _ref, _ref1;
      ...
      for (count = _i = 0, _len = tbl.length; _i < _len; count = ++_i) {
        ...
        this.info_foreach[rh].row = $.extend(true, {}, row, {
          _FIRST: count === 0,
