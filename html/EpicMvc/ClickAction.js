...
(function() {
  ...
  ClickAction = (function() {
    ...
    ClickAction.prototype.click = function(action_token, path) {
      var click_node, issue, limit, message, r, rIssues, rMessages, rNode, rResults;
      ...
      this.Epic.log2('click:' + action_token);
    ...
    ClickAction.prototype.doAction = function(node, prev_action_result) {
      var a_params_list, alias_params, class_method, found_result_tag, k, look_for_macro_result_tags, macro_node, r, rIssues, rMessages, rResults, r_vals, v;
      this.Epic.log2('doAction ', node.getTarget(), ((function() {
        var _ref, _results;
        _ref = node.getPAttrs();
        _results = [];
        for (k in _ref) {
      ...
      this.Epic.log2('doAction[r_vals,a_params_list,class_method]', r_vals, a_params_list, class_method);
      look_for_macro_result_tags = false;
      if (node.hasMacro()) {
        macro_node = this.Epic.appConf().getMacro(class_method);
    ...
    ClickAction.prototype.pullValues = function(source, value_list, attr_nm) {
      var alias, nm, nm_alias, out_list, _i, _len, _ref;
      out_list = {};
